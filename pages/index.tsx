    ...
    <>
      ...
      <div className='bg-dark font-space text-primary relative'>
        <main className='w-full h-screen flex items-center justify-center relative overflow-hidden z-50'>
          ...
          <div className='flex flex-col text-[1.5rem] gap-y-[1.5rem] items-center justify-center fixed bottom-0 right-0 pr-[1rem] md:pr-[1.5rem] lg:pr-[3rem] z-50'>
            {/* EMAIL */}
          ...
          <section className='flex flex-row justify-center items-center w-full px-[3.5rem] md:px-[4.5rem] lg:px-[7rem] lg:max-w-[100rem] z-10'>
        ...
        <section id='contact' className='w-full h-auto flex items-center justify-center relative overflow-hidden py-[5rem]'>
          <div className='h-full flex flex-col gap-y-[5rem] justify-center items-center w-full px-[3.5rem] md:px-[4.5rem] lg:px-[7rem] lg:max-w-[100rem]'>
            <Marquee gradientColor={[9, 3, 17]} gradientWidth={100} speed={100} className="overflow-hidden">
              <div className='font-bold text-8xl text-dark flex gap-x-[4rem] whitespace-nowrap'>
            ...
            <div className='flex flex-col items-center gap-y-[2.5rem]'>
              <p className='text-xl text-secondary'>Let's work together!</p>
              <p className='font-bold text-7xl'>aaronjoshua.espinosa@yahoo.com</p>
        ...
        {/* FOOTER SECTION */}
        <footer className='w-full h-auto flex items-center justify-center bg-dark text-primary font-space relative'>
          <div className='h-full flex w-full px-[3.5rem] md:px-[4.5rem] lg:px-[7rem] lg:max-w-[100rem]'>
